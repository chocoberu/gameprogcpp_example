...
{
	float vertices[] = { // 앞의 3개는 위치 좌표, 2개는 텍스처 좌표(u,v), 마지막 3개는 버텍스 색상 (일단 임의로 지정)
		-0.5f,  0.5f, 0.f, 0.f, 0.f, 0.0f,0.0f,0.0f, // top left 왼쪽 상단
		 0.5f,  0.5f, 0.f, 1.f, 0.f, 1.0f,0.0f,0.0f,// top right 오른쪽 상단
		 0.5f, -0.5f, 0.f, 1.f, 1.f, 0.0f,1.0f,0.0f,// bottom right 오른쪽 하단
		-0.5f, -0.5f, 0.f, 0.f, 1.f,  0.0f,0.0f,0.0f// bottom left 왼쪽 하단
	};
